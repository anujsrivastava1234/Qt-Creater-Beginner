...
#include <memory>
#include "../../../qt6cb-12-assignment/producer.h"
...
void Producer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Producer::test)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Producer, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
