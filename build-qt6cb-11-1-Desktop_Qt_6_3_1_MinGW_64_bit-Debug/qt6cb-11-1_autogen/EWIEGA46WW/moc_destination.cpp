...
#include <memory>
#include "../../../qt6cb-11-1/destination.h"
...
QT_MOC_LITERAL(20, 0), // ""
QT_MOC_LITERAL(21, 8), // "message1"
QT_MOC_LITERAL(30, 8), // "mySignal"
QT_MOC_LITERAL(39, 7) // "message"

    },
    "Destination\0arrived\0\0message1\0mySignal\0"
    "message"
};
...
void Destination::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->arrived((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->mySignal((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Destination::*)(QString );
...
, QtPrivate::TypeAndForceComplete<Destination, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QString, std::false_type>
...
// SIGNAL 0
void Destination::arrived(QString _t1)
{
