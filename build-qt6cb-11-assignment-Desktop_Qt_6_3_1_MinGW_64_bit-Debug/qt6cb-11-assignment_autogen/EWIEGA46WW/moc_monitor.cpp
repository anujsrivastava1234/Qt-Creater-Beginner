...
#include <memory>
#include "../../../qt6cb-11-assignment/monitor.h"
...
const QMetaObject Monitor::staticMetaObject = { {
    ...
    qt_meta_stringdata_Monitor.offsetsAndSize,
